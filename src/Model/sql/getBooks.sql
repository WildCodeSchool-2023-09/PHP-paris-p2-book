SELECT
-- DATA TO DISPLAY :
    be.id as id, b.title as title, CONCAT(a.firstname, ' ', a.lastname) as author, be.cover as cover, e.label as editor, b.written_at as date, g.label as genre, t.label
